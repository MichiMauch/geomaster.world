    ...
    <div className="w-full space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        {showResend && (
          <div className="mt-3 p-2 bg-warning/10 border border-warning/20 rounded-lg">
            <p className="text-xs text-warning mb-2">{t("emailNotVerified")}</p>
            <Button
              type="button"
              variant="secondary"
              size="sm"
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="px-3 bg-surface-1 text-text-muted">
            {t("orContinueWith")}
          </span>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <Link
          ...
          className={cn(
            "flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg",
            "bg-surface-2 text-text-secondary text-sm font-medium",
      ...
      {/* Guest Play - Text Link */}
      <p className="text-center text-sm text-text-muted pt-1">
        <button
          type="button"
          onClick={handleGuestPlay}
          className="text-text-secondary hover:text-primary transition-colors underline cursor-pointer"
        >
          {t("playAsGuest")}
        </button>
      </p>
