...
export function NewsModal({ news, locale }: NewsModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md max-h-[80vh] animate-fade-in flex flex-col rounded-xl bg-surface-1 border border-glass-border shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="shrink-0 relative px-6 pt-6 pb-4 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent">
          <button
            onClick={handleDismiss}
        ...
        {/* Content */}
        <div className="overflow-y-auto min-h-0 px-6 py-4">
          <div
